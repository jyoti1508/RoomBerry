    ...
    <div>
      <form onSubmit={onSubmitHandler}>
        <Title
          ...
          font="outfit"
          title="Add Room"
          subTitle="Fill in the details carefully and accurate room details, pricing, and amenities, to enhance use booking experience "
        />
        ...
        <div
          className="flex flex-col flex-wrap mt-1
